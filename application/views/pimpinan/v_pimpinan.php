                ...
                <div class="modal fade" id="basicModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form method="POST" action="<?= site_url('admin/pimpinan/add') ?>">
                                <div class="modal-header">
                                    <h5 class="modal-title">Penentuan Akun Pimpinan </h5>
                                ...
                                foreach ($pimpinan as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('admin/pimpinan/hapus/' . $row->ID_LOGIN) ?>" onclick="return confirm('Anda yakin mau menghapus data ini ?')"><button type="button" class="btn btn-outline-danger" title="Hapus Data">
...
<?php foreach ($pimpinan as $edit) { ?>
    <div class="modal fade" id="editModal<?= $edit->ID_LOGIN ?>" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="<?= site_url('admin/pimpinan/edit') ?>">
                    <div class="modal-header">
                        <h5 class="modal-title">Update Penentuan Akun Pimpinan </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row mb-3">
