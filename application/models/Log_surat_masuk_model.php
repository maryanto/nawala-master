...
class Log_surat_masuk_model extends CI_Model
{
    private $_table = "t_log_surat_masuk";
    private $_view = "v_log_surat_masuk";
    ...
    public function add_log($username, $id_surat_masuk, $pesan)
    {
